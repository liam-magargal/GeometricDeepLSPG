...
def trainModel(model, optimizer, w_train, w_val, batchSize, maxEpoch, e1, e2, e3, e4, e5, s1, s2, s3, s4, u1, u2, u3, u4, pos1, pos2, pos3, pos4, pos5, ai_54, ai_43, ai_32, ai_21, labels1, labels2, labels3, labels4, labels5, N_lat):
    ...
    for epoch in range(maxEpoch):
        ...
        torch.save(model, 'lat' + str(N_lat))
...
if __name__=="__main__":
    ...
    labels5 = torch.load(directory + 'labels5')
    ...
    model, optimizer = defineModel(lat_dim)

    model = trainModel(model, optimizer, w_train, w_val, batchSize, maxEpoch, e1, e2, e3, e4, e5, s1, s2, s3, s4, u1, u2, u3, u4, pos1, pos2, pos3, pos4, pos5, ai_54, ai_43, ai_32, ai_21, labels1, labels2, labels3, labels4, labels5, lat_dim)
