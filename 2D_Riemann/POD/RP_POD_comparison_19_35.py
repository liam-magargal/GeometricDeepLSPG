...
if __name__=="__main__":
    ...
    # load mesh 
	mesh_location = '../Mesh/'
	GT_directory = '../fullOrderModel/Outputs/19_3.5'
	pred_directory = 'lat' + str(lat_dim) + '_19_3.5'
	filename = 'output'

	x_hist_GT = loadData('output', mesh_location, GT_directory, 'cell_volumes.npy', ns, 1.4)
	x_hist_pred = loadData('output', mesh_location, pred_directory, 'cell_volumes.npy', ns, 1.4)
